...
public class SwipeRight extends Activity implements
...
//        toast.show();
    ...
    public void onSwipeRight() {
        Intent myIntent = new Intent(SwipeRight.this, SwipeLast.class);
        SwipeRight.this.startActivity(myIntent);
    }

    public void onSwipeLeft() {
        Intent myIntent = new Intent(SwipeRight.this, MainActivity.class);
        SwipeRight.this.startActivity(myIntent);
    }
